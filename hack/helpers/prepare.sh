...
sed -i.bak "s/workload-manager-provider/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/workload-manager-provider" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/workload-manager-provider-controller" "cluster/images/provider-${ProviderNameLower}-controller"
